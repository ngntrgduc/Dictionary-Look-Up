// document.getElementsByClassName("hfr-s lt2s lmt-10")[0].style.display = "none"; // Hide right banner
document.getElementsByClassName("bw hbss lp-10 lmb-25 pr")[0].style.display = "none"; // Hide quizs

// Hide `Want to learn more`
document.getElementsByClassName("bb hax")[0].style.display = "none";
